...
![Docker Hub Click on Search Images to Run](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/01-docker-hub-search-images-to-run.png)
1. Search for image "devopsshield/devopsshield" and click pull
![Find image for devopsshield](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/02-pull-devopsshield-container.png)
1. Click on run
![click on run](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/03-click-on-run.png)
1. Choose host port (e.g. 8080) in optional settings then click on run
![add host port](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/04-add-host-port-in-optional-settings-then-click-on-run.png)
1. Now browse to the app at <http://localhost:8080> or simply click on the hyperlink below
![browse localhost on port 8080](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/05-click-on-browse-port-8080-on-localhost.png)
1. Login to the app by clicking login button on top right
![click on login button](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/06-click-on-login-button.png)
1. Log in with username **devopsshield** and password **devopsshield**. You will then be prompted to change your password.
![enter default password](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/07-enter-password-then-login.png)
1. Change default password
![change password](https://github.com/devopsshield/devops-shield/blob/main/media/images/install/08-change-password.png)
...
![get full pat token](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/04-generate-full-pat-token-for-azure-devops-organization-to-assess.png)
1. Don't for get to copy the PAT to the clipboard!
![copy PAT token](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/04-click-on-copy-icon-to-copy-to-clipboard.png)
...
![get microsoft entra id](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/03-microsoft-entra-id-for-azure-devops-organization.png)

### Config Steps

1. In the app, click on setup configuration
![setup configuration](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/01-click-on-setup-configuration.png)
1. Now click on Quick Setup - Get Started
![quick setup - get started](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/02-click-on-quick-setup-get-started.png)
...
![fill out with your values](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/05-fill-out-with-your-values.png)
1. You should quickly see the setup configuration done as below:
![config done](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/06-config-done.png)
1. Go to Automation Tasks and wait for the scan to complete
![automation tasks](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/07-go-to-automation-tasks.png)
...
![wait for tasks to finish](https://github.com/devopsshield/devops-shield/blob/main/media/images/config/08-assessment-scan-completed.png)
...
![click on DevOps Assessments](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/01-click-on-devops-assessments.png)
Clicking on any individual assessment, we see:
![sample assessment details](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/02-sample-assessment-details.png)
Clicking on View & Export Reports:
![view and export reports](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/03-view-and-export.png)
Scroll Down to see the full report including: DevOps Security Overview, DevOps Governance and Compliance, DevOps Inventory
![devops governance and compliance](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/04-devops-governace-and-compliance.png)
![devops inventory](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/05-devops-inventory.png)
Please note that the Community Edition is limited to seeing up to 10 Azure DevOps Resources in these Assessment Reports
![limit of up to 10 resources in community edition](https://github.com/devopsshield/devops-shield/blob/main/media/images/assessments/06-devops-inventory-limited-in-community-edition.png)
